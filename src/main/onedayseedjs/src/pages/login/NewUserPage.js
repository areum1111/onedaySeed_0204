      ...
      <div className="loginBox">
        <h1><b>회원가입</b></h1>
          <Form onSubmit={handleSubmit}>
            ...
            <input className="formInfo" type="password" id="password_val" placeholder="비밀번호를 입력해주세요" onChange={handleInputChange} value={newMember.userPassword}/>

            <span className="formName" >이름</span>
            <input className="formInfo" type="text" id="name_val" placeholder="이름을 입력해주세요" onChange={handleInputChange} value={newMember.userName} />

            <span className="formName">전화번호</span>
          <input className="formInfo" type="text" id="phoneNum_val" placeholder="전화번호를 입력해주세요" onChange={handleInputChange} value={newMember.userPhoneNum}/>
