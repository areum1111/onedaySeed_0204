      ...
      <div className="collapse navbar-collapse" id="navbarSupportedContent">
        <ul className="navbar-nav me-auto mb-2 mb-lg-0">
          <li className="nav-item">
            <a className="nav-link active" id="nav-a1" aria-current="page" href="#!">About Us</a>
          </li>
          <li className="nav-item">
            <a className="nav-link" id="nav-a2" href="#!">My Page</a>
          </li>
          ...
          <li className="nav-item">
            <a className="nav-link disabled" id="nav-a3" aria-disabled="true">Login</a>
          </li>
        </ul>
