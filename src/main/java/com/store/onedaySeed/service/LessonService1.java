...
import com.store.onedaySeed.dto.LessonDto1;
...
//    }
    ...
    // 클래스 저장
    public Long saveLesson(LessonDto1 lessonDto){
        Lesson lesson = lessonDto.createLesson();
        lessonRepository.save(lesson);
        return lesson.getLessonId();
    }
    public List<LessonDto1> getAllLesson() {
        List<Lesson> lessons = lessonRepository.findAll();
        List<LessonDto1> lessonDtos = new ArrayList<>();
    ...
    private LessonDto1 convertToDto(Lesson lesson) {
        return new LessonDto1(
                lesson.getLessonId(),
    ...
    public LessonDto1 getLessonDetail(Long lessonId) {
